...
<body class="bg-white">
    ...
    <h4>Sửa cơ sở vật chất</h4>
    <c:url value="/sua-co-so-vat-chat" var="url"/>
    <form:form modelAttribute="facilities" method="post" action="${url}">
         ...
         <p>Ngày mua</p> <form:input type="date" id="date-buy" name="date-buy" oninput="validDate()" class="mb-3" path="date_buy"/>
